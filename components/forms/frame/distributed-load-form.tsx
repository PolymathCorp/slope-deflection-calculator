...
export default function DistributedLoadForm({ frameData, setFrameData }: DistributedLoadFormProps) {
  ...
  const [startMag, setStartMag] = useState("")
  const [endMag, setEndMag] = useState("")
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    const newDistLoad = {
      ...
      startMag: Number.parseFloat(startMag) || 0,
      endMag: Number.parseFloat(endMag) || 0,
        ...
        <div>
          ...
          <div className="relative">
            <input
              type="number"
              value={startMag}
              onChange={(e) => setStartMag(e.target.value)}
        ...
        <div>
          ...
          <div className="relative">
            <input
              type="number"
              value={endMag}
              onChange={(e) => setEndMag(e.target.value)}
              className="w-full p-3 pr-16 border border-gray-200 rounded-lg bg-white"
